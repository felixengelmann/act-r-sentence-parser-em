...
datameans <- c(564.4274, 701.4310, 571.8799, 477.3900, 424.8824)
#datatu <- c(616.4060, 783.5852, 781.8033, 632.7439, 521.1400, 460.9614)
datatu <- c(616.4060, 783.5852, 632.7439, 521.1400, 460.9614)
#datatl <- c(512.4489, 619.2768, 630.0317, 511.0159, 433.6401, 388.8034)
datatl <- c(512.4489, 619.2768, 511.0159, 433.6401, 388.8034)
